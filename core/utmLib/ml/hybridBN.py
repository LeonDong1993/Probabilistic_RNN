...
from utmLib.clses import ProgressIndicator, CONST
from utmLib.ml.potential import PotentialWrapper, CLG, SoftMax, CPT
from utmLib.ml.solver import EPBP
from utmLib.ml.graph import Graph, Node
from utmLib.utils import crossprod
...
class HybridBN:
    ...
    def fit(self,traindata):
        pi = ProgressIndicator(self.g.N, "Learning")
